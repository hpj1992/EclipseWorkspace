...
exports.updateProfile =function (req,res)
{
	...
	var queryString = 'Update person set firstName="'+firstname+'",lastName="'+lastname+'",email="'+email+'",password="'+password+'",city="'+city+'",zipcode="'+zip+'",state="'+state+'",phone="'+phone+'",address1="'+address1+'",address2="'+address2+'",country="'+country+'" where email="'+email+'";';
	console.log(queryString);
	mysql.fetchData(function(err, results) {
	    if (err) 
	    	{
