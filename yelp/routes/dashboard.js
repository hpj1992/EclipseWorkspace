...
var user=exports.user=function(req,res)
{
	...
	var getFirstname="select * from users where email='hpj1992@gmail.com'";
	var firstname;
	var date=new Date();
	var time=date.getFullYear()+"-"+date.getMonth()+"-"+date.getDate()+" "+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds();
	var updateLastModified="update users set lastmodified='"+time+"' where email='hpj1992@gmail.com';";
							...
							else 
							{
								...
								mysql.fetchData(function(err,businesses){
									...
									else 
									{
										...
										res.send("Login SUccessful"+firstname+" "+lastModified+""+results);
