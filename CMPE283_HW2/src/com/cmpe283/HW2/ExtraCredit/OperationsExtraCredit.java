...
public class OperationsExtraCredit {
	...
	public void getHostDetails(Folder rootFolder, VirtualMachine vm) throws InvalidProperty, RuntimeFault, RemoteException
	{
		int cnt = 0;
